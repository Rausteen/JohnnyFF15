...
import { XCircle, CheckCircle, Clock, Skull, Wifi, WifiOff, AlertTriangle, Gamepad2, Timer, Users, LogIn } from 'lucide-react';
          ...
          <div className="bg-gradient-to-r from-green-900/30 via-green-800/20 to-emerald-900/30 p-6">
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-green-300">
                    {johnny.gameName}#{johnny.tagLine} • {currentGame?.gameMode}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-6">
                ...
                {johnnyInGame && (
                  <div className="text-center">
                    <div className="text-lg font-bold text-white">Champion #{johnnyInGame.championId}</div>
                    <div className="text-xs text-green-300 uppercase">En jeu</div>
                  </div>
                )}
              </div>
            </div>
