...
ADD COLUMN IF NOT EXISTS equipped_background TEXT DEFAULT NULL;
...
COMMENT ON COLUMN profiles.equipped_background IS 'Currently equipped video background cosmetic ID';
